...
| MAUI Blazor Hybrid | .NET 10 / MAUI 10.0.101 | Compilation et exécution WebView2 vérifiées | L'application Windows minimale charge `HybridSmoke` dans `BlazorWebView`; la sonde CDP clique `#hybrid-action`, constate le compteur à 1 et exige une console sans erreur. |
