...
# PLAN-002 - Grille complète et virtualisation

> Objectif : `OmniDataGrid` couvre l'intégralité de la surface de grille et de colonne observée
> dans les applications consommatrices, avec virtualisation à défilement continu et
> **hauteur de tableau paramétrable**.
> Source de vérité du besoin : les paramètres réellement utilisés par ces applications.
...
- Indépendance : aucun code, CSS, script ni test provenant d'une autre bibliothèque. Seuls les
  **noms de paramètres observés** guident le besoin.
