...
// Only the glyphs the package itself renders are embedded here; consumers reach any other icon
// through OmniIcon.Glyph, so the catalogue is never shipped.
internal static class PhosphorIconGlyphs
{
    private static readonly OmniIconGlyph Check = OmniIconGlyph.Phosphor(
        "M229.66,77.66l-128,128a8,8,0,0,1-11.32,0l-56-56a8,8,0,0,1,11.32-11.32L96,188.69,218.34,66.34a8,8,0,0,1,11.32,11.32Z");

    private static readonly OmniIconGlyph Close = OmniIconGlyph.Phosphor(
        "M205.66,194.34a8,8,0,0,1-11.32,11.32L128,139.31,61.66,205.66a8,8,0,0,1-11.32-11.32L116.69,128,50.34,61.66A8,8,0,0,1,61.66,50.34L128,116.69l66.34-66.35a8,8,0,0,1,11.32,11.32L139.31,128Z");

    private static readonly OmniIconGlyph Info = OmniIconGlyph.Phosphor(
    ...
    private static readonly OmniIconGlyph Warning = OmniIconGlyph.Phosphor(
        "M236.8,188.09,149.35,36.22h0a24.76,24.76,0,0,0-42.7,0L19.2,188.09a23.51,23.51,0,0,0,0,23.72A24.35,24.35,0,0,0,40.55,224h174.9a24.35,24.35,0,0,0,21.33-12.19A23.51,23.51,0,0,0,236.8,188.09ZM222.93,203.8a8.5,8.5,0,0,1-7.48,4.2H40.55a8.5,8.5,0,0,1-7.48-4.2,7.59,7.59,0,0,1,0-7.72L120.52,44.21a8.75,8.75,0,0,1,15,0l87.45,151.87A7.59,7.59,0,0,1,222.93,203.8ZM120,144V104a8,8,0,0,1,16,0v40a8,8,0,0,1-16,0Zm20,36a12,12,0,1,1-12-12A12,12,0,0,1,140,180Z");

    private static readonly OmniIconGlyph ChevronDown = OmniIconGlyph.Phosphor(
        "M213.66,101.66l-80,80a8,8,0,0,1-11.32,0l-80-80A8,8,0,0,1,53.66,90.34L128,164.69l74.34-74.35a8,8,0,0,1,11.32,11.32Z");

    private static readonly OmniIconGlyph Menu = OmniIconGlyph.Phosphor(
    ...
    private static readonly OmniIconGlyph Filter = OmniIconGlyph.Phosphor(
        "M230.6,49.53A15.81,15.81,0,0,0,216,40H40A16,16,0,0,0,28.19,66.76l.08.09L96,139.17V216a16,16,0,0,0,24.87,13.32l32-21.34A16,16,0,0,0,160,194.66V139.17l67.74-72.32.08-.09A15.8,15.8,0,0,0,230.6,49.53ZM40,56h0Zm108.34,72.28A15.92,15.92,0,0,0,144,139.17v55.49L112,216V139.17a15.92,15.92,0,0,0-4.32-10.94L40,56H216Z");

    private static readonly OmniIconGlyph SortAscending = OmniIconGlyph.Phosphor(
    ...
    private static readonly OmniIconGlyph SortDescending = OmniIconGlyph.Phosphor(
    ...
    private static readonly OmniIconGlyph ThemeDark = OmniIconGlyph.Phosphor(
    ...
    private static readonly OmniIconGlyph ThemeLight = OmniIconGlyph.Phosphor(
    ...
    internal static OmniIconGlyph For(OmniIconName name) => name switch
    {
        OmniIconName.Check => Check,
        OmniIconName.Close => Close,
        OmniIconName.Info => Info,
        OmniIconName.Warning => Warning,
        OmniIconName.ChevronDown => ChevronDown,
        OmniIconName.Filter => Filter,
        OmniIconName.SortAscending => SortAscending,
        OmniIconName.SortDescending => SortDescending,
        OmniIconName.ThemeDark => ThemeDark,
        OmniIconName.ThemeLight => ThemeLight,
        _ => Menu,
    };
}
